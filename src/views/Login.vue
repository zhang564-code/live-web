      ...
      <el-main>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item>
            ...
            <el-button type="primary" v-on:click="toStudentLogin">学生登录</el-button>
            <el-button type="success" v-on:click="toTeacherLogin">教师登录</el-button>
            <el-button type="info" v-on:click="toAdminLogin">管理员登录</el-button>
            <el-link v-on:click="toLoginStar">更换主题登录</el-link>
