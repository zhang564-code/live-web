      ...
      <el-main>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-form-item label="教师姓名" prop="teacher_name">
            <el-input v-model="ruleForm.teacher_name" @keydown.enter.native="submitForm"></el-input>
          </el-form-item>
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            const _this = this
            this.$axios.post('/teacher/login', this.ruleForm).then(res => {
              ...
              _this.$store.commit("SET_TEACHERINFO", teacherInfo)

              // 获取
              console.log(_this.$store.getters.getTeacher)
      ...
      registerForm() {
            const _this = this
            _this.$router.push("/teacher/register")
      },
    tologin () {
