 <template>
   <div id="login">
     ...
     <div id="loginBox">
       <h4>学生登录</h4>
       <el-form :model="ruleForm" :rules="loginRules" ref="ruleForm" label-width="0px">
         <el-form-item label="" prop="student_name" style="margin-top:40px;">
           <el-row>
             <el-col :span='2'>
               <span class="iconfont">&#xe654;</span>
             </el-col>
             <el-col :span='22'>
               <el-input class="inps" placeholder='用户名' v-model="ruleForm.student_name"></el-input>
             </el-col>
           </el-row>
         </el-form-item>
         <el-form-item label="" prop="password">
           <el-row>
             ...
             <el-col :span='22'>
               <el-input class="inps" type="password" placeholder='密码' v-model="ruleForm.password"
               ></el-input>
             </el-col>
           </el-row>
         </el-form-item>
         ...
         <el-form-item>
           ...
           <el-link v-on:click="tologin" type="warning">返回</el-link>
         </el-form-item>
